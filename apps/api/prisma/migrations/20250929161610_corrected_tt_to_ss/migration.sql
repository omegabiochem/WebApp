/*
  ...
  - The values [FINAL_RESUBMITTION_BY_CLIENT,PRELIMINARY_RESUBMITTION_BY_TESTING,FINAL_RESUBMITTION_BY_TESTING] on the enum `ReportStatus` will be removed. If these variants are still used in the database, this will fail.
