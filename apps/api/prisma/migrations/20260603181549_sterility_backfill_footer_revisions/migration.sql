-- This is an empty migration.-- This is an empty migration.-- This is an empty migration.-- This is an empty migration.

UPDATE "sterilityDetails" AS d
SET
  "footerRevNo" = CASE
