...
//         createPortal(
//           <div
//             className="no-print fixed inset-0 z-[2147483647] bg-black/60 flex items-center justify-center p-4"
//             onClick={() => setOpenId(null)}
//           >
//             <div
//               className="bg-white rounded-lg shadow max-w-5xl w-full h-[80vh] overflow-auto"
//               onClick={(e) => e.stopPropagation()}
//               role="dialog"
//               aria-modal="true"
//             >
...
//       d.className =
//         "fullscreen-frame fixed inset-0 z-[2147483647] overflow-auto p-4 bg-white/95 overscroll-contain";
//       //            ↑ absurdly high z-index so nothing beats it
//       return d;
//     }, []);
...
//       // 🔒 hide the entire app behind the portal
//       const appRoot = document.getElementById("root"); // Vite/CRA default
//       const prevVisibility = appRoot?.style.visibility ?? "";
...
//         if (appRoot) appRoot.style.visibility = prevVisibility; // restore
//         body.removeChild(el);
//       };
//     }, [el]);
...
//           role="dialog"
//           aria-modal="true"
//           className="sheet relative mx-auto max-w-[800px] bg-white text-black border border-black shadow p-4 max-h-[100dvh] overflow-y-auto"
//         >
//           <PrintStyles />
...
//                 >
//                   DENOTES: NA (Not Applicable) / N.G. (No Growth) / GM.(+)B Gram
//                   (+) Bacilli / GM.(+)C Gram (+) Cocci / GM.NEG Gram Negative /
